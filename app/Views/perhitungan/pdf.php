...
<body onload="window.print();">
    <h5 class="card-title" hidden>Tabel Data Alternatif</h5>
    ...
    <h5 class="card-title" style="margin-top: 50px;" hidden>Tabel Hasil Konfersi Data Alternatif</h5>
    <table class="table table-striped" hidden>
        <thead>
            <tr>
    ...
    <h5 class="card-title" style="margin-top: 350px;" hidden>Tabel Alternatif Untuk Setiap Kriteria</h5>
    <table class="table table-striped" hidden>
        <thead>
            <tr>
                <?php
    ...
    <h5 class="card-title" style="margin-top: 50px;" hidden>Matriks</h5>
    ...
    <div class="col-lg-12" style="margin-top: 350px;" hidden>
    ...
    <div class="col-lg-12">
        <h5 class="card-title text-center">Daftar Nama penerima BNPT</h5>
        <h5 class="card-title text-center">Desa Muncan Tahun 2022</h5>
